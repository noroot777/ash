...
> 历史说明：文中的 `web/src/*` 是当时的实现路径；旧 SPA 已于 2026-08-02 退役，当前前端位于 `web-next/src/*`。
...
4. **把派单方搬进 harness**:「我现在一直是在 claude desktop 问你的,如果我在 harness 里直接跟 claude 说让他调度 codex 干活,可不可以做到?」
