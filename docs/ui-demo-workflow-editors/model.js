...
(function (global) {
  ...
  var KINDS = {
    run: {
      label: "让 AI 干活", tag: "agent.run", hasFail: true,
    ...
    verify: {
      label: "自动验证", tag: "agent.verify", hasFail: true,
    ...
    human: {
      label: "等我点头", tag: "human.gate", hasFail: true,
    ...
    command: {
      label: "跑一条命令", tag: "shell.run", hasFail: true,
