// 收敛门附件链路的回归钉子:GateAction.attachments → 辩手 prompt / 时间线气泡 的成稿。
...
import { gateUserMessage } from "../src/debate/user-message.js";
...
// 只贴图不打字:必须有兜底句,否则 prompt 末尾只剩路径,辩手不知道要拿它们干什么。
