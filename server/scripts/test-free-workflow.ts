...
try {
  ...
  const { mountFreeWorkflowRoutes, freeReviewOutcome, freeReviewPrompt, freeRepairPrompt, freeReviewResumeOptions, handleFreeWorkflowSettlement } = await import("../src/free-workflow.js");
