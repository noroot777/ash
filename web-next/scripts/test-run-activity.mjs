...
import { runActivityCopy } from "../src/lib/runActivity.ts";
...
assert.deepEqual(
  runActivityCopy({ status: "queued", mode: "single", queuePosition: 1 }),
  { title: "已进入队列 · 第 2 位", detail: "前面的任务结束后会自动启动，无需重复点击。" },
);
