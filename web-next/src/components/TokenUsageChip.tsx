 ...
 *
 * **位置是固定的两处，不随气泡是不是会话最后一条而变**：气泡头部那颗是「本轮」（跟旁边
 * 的 ⏱ 用时同族，都是这一轮的成本），气泡尾部 SessionMeta 里那颗是「会话」累计（跟会话
 * id、resume 命令同族）。曾经把最后一条气泡的本轮抽到尾巴上跟累计并成一颗，结果同一个数
 * 在顶和底之间跳，规则还看不见（用户 2026-08-07 报「位置不正常」）。
 *
