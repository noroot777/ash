    ...
    <main style={{ display: "grid", minHeight: "100%", placeItems: "center", padding: 28 }}>
      <section style={{ width: 390 }}>
        <header style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
          <button type="button" data-testid="task-a" onClick={() => { setTaskId("tree-a"); setActivePath(null); }}>
            任务 A
          </button>
          <button type="button" data-testid="task-b" onClick={() => { setTaskId("tree-b"); setActivePath(null); }}>
            任务 B
          </button>
        ...
        >
          <FileTreeInspector taskId={taskId} activePath={activePath} onOpenFile={setActivePath} />
        </div>
