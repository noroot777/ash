// 编排时的连带修复（web/src/workflow/workflowEdit.ts）。
//
...
//
// 跑法：npm -w web run test:workflow-edit
import assert from "node:assert/strict";
import { MAX_WORKFLOW_STEPS, isWorkflowUsable, makeStep } from "@ash/shared/workflow";
import {
