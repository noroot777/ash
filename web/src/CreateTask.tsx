...
type SlashAction =
  | { cmd: "pair"; kind: "pair"; style: DebateStyle; label: string; hint: string; icon: ReactNode }
  | { cmd: "team"; kind: "team"; label: string; hint: string; icon: ReactNode };

const SLASH_COMMANDS: SlashAction[] = [
  { cmd: "pair", kind: "pair", style: "debate", label: "辩论", hint: "两个 AI 对抗，给你答案", icon: <Scales size={17} className="shrink-0 text-violet-600" /> },
  { cmd: "pair", kind: "pair", style: "collaborate", label: "协作", hint: "一方实现、一方审查，给你代码", icon: <Handshake size={17} className="shrink-0 text-teal-600" /> },
...
// `/pair` 交给辩论/协作那套弹窗,`/team` 就地把这张单子切成「团队」模式。
export function CreateTask({
  ...
  const pickSlash = (a: SlashAction) => {
    setBody("");
    setSlashIdx(0);
    if (a.kind === "pair") onDebate(a.style);
          ...
          <textarea
            ...
            placeholder={
              teamOn
                ...
                : "描述要做什么 / 给 agent 的目标…（输入 / 唤起命令：/pair 双 AI，/team 一队）"
            }
