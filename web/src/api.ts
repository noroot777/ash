import type { Project, ProjectView, ProjectHealth, Task, Session, Group, GateAction, Schedule, ScheduledMessage, AgentExecutorProfile, BatchCreateTasksBody, AgentType, AttachmentKind, Issue, IssueComment, AiBackend, LlmProvider, LlmProtocol, SearchHit, TeamPreset, TeamPresetConfig } from "@harness/shared";
