...
export function AssistantView({ project, projects, onTask, onSettings, onExit }: {
  ...
  return <section className="assistant-shell" aria-label="ash 助手">
    <header className="assistant-header"><div className="assistant-identity"><Robot size={23} weight="duotone" /><div><h1>ash 助手</h1><span>{project ? `当前项目 · ${project.name}` : "你的 ash 使用助手"}</span></div></div>
