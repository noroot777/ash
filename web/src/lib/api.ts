...
export const api = {
  ...
  abandonTaskBaseUpdate: (taskId: string, fingerprint: string, resolution: "abandon" | "complete"): Promise<{ ok: boolean; message: string }> => request(`/tasks/${id(taskId)}/abandon-base-update`, json("POST", { fingerprint, resolution })),
