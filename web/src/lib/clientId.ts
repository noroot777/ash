...
function uuidFromRandomValues(cryptoApi: Pick<Crypto, "getRandomValues">): string {
...
export function createClientId(cryptoApi: ClientCrypto | null | undefined = globalThis.crypto): string {
