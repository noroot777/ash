...
export function AnnotationFallback({ taskId, records, queueing }: { taskId: string; records: AnnotationBatchRecord[]; queueing: boolean }) {
  ...
  return <div className="annotation-fallback">
    <ScreenshotAnnotation taskId={taskId} disabled={false} queueing={queueing} executorLabel="此任务的智能体"
      triggerLabel="此页面在内嵌预览中表现异常？改用截图批注"
